...
public class MainActivity<OnActivityResulty> extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (signInAccount != null) {
            ...
            CircleImageView imaactivitycarditemge = headerView.findViewById(R.id.headimage);
            String personImage = Objects.requireNonNull(signInAccount.getPhotoUrl()).toString();
            Glide.with(this).load(personImage).into(
                    imaactivitycarditemge
            );
...
//                dialog.dismiss();
    ...
    private void setbottomSheetDialog (){
        bottomSheetDialog = new BottomSheetDialog(this, com.google.android.material.R.style.Theme_Design_BottomSheetDialog);
